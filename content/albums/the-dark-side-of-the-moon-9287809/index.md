...
Comes with a rectangular sticker and a round hype sticker on the front of the shrink wrap.
Release contains two posters and two postcard-sized stickers like the original release.
Some copies have been sold with a wrong rectangular sticker from [r=8961614] instead of the regular one (see picture).
...
[Runouts]:
In all cases, '16690 [#]A' and '16690 [#]B' are stamped, with the remainder being etched.
